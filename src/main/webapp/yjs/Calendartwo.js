...
function fPop(evt,popCtrl,dateCtrl){
...
function fSetDate2(iYear,iMonth,iDay){
    ...
    alert(riqiValue);
    alert("ceshi222222222:"+subcurrentDateEnd);
    fHideCalendar();
...
function getDateDiv(){
    ...
    dateDiv+="<span onclick=\"clearDate();\" style=\"font-size:12px;cursor:pointer;\"  onmouseover='this.style.color=\""+gcMouseOver+"\"' onmouseout='this.style.color=\"#000000\"'>清空</span>      <span style='cursor:pointer; font-size:12px' onclick='fSetDate2(giYear,giMonth,giDay)' onmouseover='this.style.color=\""+gcMouseOver+"\"' onmouseout='this.style.color=\"#000000\"'>"+strToday+":"+giYear+strYear+giMonth+strMonth+giDay+strDay+"</span>";
    dateDiv+="</tr></tr>";  
